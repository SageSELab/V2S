...
# module import edited to fit v2s structure
from v2s.phase1.detection.object_detection.protos import string_int_label_map_pb2
...
def load_labelmap(path):
  ...
  """
  with tf.gfile.Open(path, 'r') as fid:
